<?php
   ...
   $sql_rec = 'SELECT count(id) as total FROM user';
...
<html>
    <head>
        ...
        <title>ADMIN</title>
        <link rel="stylesheet" href="assets/css/mnguser.css?v=<?=rand(1,10000)?>">
    </head>
    <body>
        <div class="container">
            <div class="box">
            ...
            <div>
                ...
                <div class="container1">
                    ...
                    <a href="themuser.php"><button class="btn1"><img src="assets/images/Icon awesome-plus-circle.png"> Thêm</button></a>
                </div>
                <table id="customers">
                    <tr>
                        <th>ID</th>
                    ...
                    <?php 
                        ...
                        <td>
                            <a href="edituser.php?id=<?php echo $row['id']; ?>"><img src="assets/images/Icon awesome-sticky-note.png"></a>
                            <a href="xoauser.php?id=<?php echo $row['id']; ?>"><img src="assets/images/Icon material-delete-forever.png"></a>
                        </td>
                    </tr>
                    <?php endwhile; ?>  
                </table>
                <div style="text-decoration: none; font-size: 20px; padding-top: 25px; text-align: center">
                    <?php
                        if($current_page > 1 && $total_page > 1){
                            echo'<a href="mnguser.php?page='.($current_page-1).'"> << <a> | ';
                        }
                        for($i=1 ; $i<$total_page ; $i++){
                            if($i==$current_page){
                                echo'<span>'.$i.'</span> |';
                            }else{
                                echo'<a href="mnguser.php?page='.$i.'">'.$i.'</a> | ';
                            }
                        }
